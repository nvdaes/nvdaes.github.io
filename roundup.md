...
Este artículo se actualizó por última vez después de repetir los test en agosto de 2019.

### Introducción ###

Con la llegada de la publicación digital y los libros electrónicos, ahora las personas con discapacidades de acceso a la lectura tienen ocasión de disfrutar de un número sin precedentes de libros y otras publicaciones. Los editores están incrementando la adopción de estándares, técnicas y herramientas para garantizar que sus títulos sean accesibles.

A un libro digital se accede mediante una app de lectura, que se emplea para abrir, leer y navegar por el contenido. Es importante que tanto particulares como organizaciones puedan elegir sistemas de lectura que ofrezcan las características de accesibilidad que necesitan. Las características requeridas serán distintas según las personas, y podrían incluir la posibilidad de usar un lector de pantalla, cambiar el aspecto visual del contenido, una función de lectura en voz alta, una función para ampliar imágenes, y así sucesivamente.
...
El software de lectura de Adobe es ampliamente usado para leer ficheros pdf, pero también lee EPUB. Está disponible en la mayoría de plataformas para teléfonos y ordenadores. A menudo lo recomiendan bibliotecas públicas y académicas, porque las obras que se prestan mediante sus sistemas utilizan la protección contra copia de Adobe. Es la única opción para títulos descargados desde muchos sistemas de bibliotecas, y desgraciadamente es difícil de recomendar debido a una estabilidad deficiente y a falta de características fundamentales de accesibilidad.
...
Para tener en cuenta: La lectura continua con lector de pantalla se detiene al cabo de unas pocas páginas, debido al modo en que la app muestra la obra. En Android y Windows, no es posible activar los enlaces cuando se usa lector de pantalla.

#### [Edge](https://www.microsoft.com/en-us/windows/microsoft-edge) ####

¡El navegador web incluido en Windows 10 también es un lector de EPUB! Es la aplicación por defecto para leer EPUB en Windows 10, así que utilizarla es tan sencillo como abrir un ebook en formato EPUB desprotegido.

Lo que gustó a nuestros evaluadores: Los libros se pueden abrir directamente desde un sitio web o en el explorador de Windows. Se destacó la implementación de la función de lectura en voz alta con resaltado visual. Los ajustes visuales incluyen más de 20 colores de fondo, la posibilidad de aumentar el espacio entre letras, y diferentes partes del texto pronunciado pueden mostrarse en diferentes colores.

Para tener en cuenta: El lector de EPUB incluido en Edge será sustituido por otras soluciones en una próxima actualización de Windows (posiblemente en el primer trimestre de 2020).
...
Lo que gustó a nuestros evaluadores: El aspecto visual de la obra se puede adaptar para adecuarse a las necesidades de los lectores. Algunas imágenes se amplían a pantalla completa al seleccionarlas, lo que resulta útil en las pantallas más pequeñas y para gente con baja visión.

Para tener en cuenta: Apple Books no está disponible en Android ni en Windows.

#### [Kurzweil 3000](https://www.kurzweil3000.com/) ####

La versión de Kurzweil 3000 de licencia web ofrece una potente ayuda a estudiantes con diferencias en el acceso a la lectura como la dislexia. Es posible subir contenido, incluidas obras en EPUB 3, a la ‘Universal Library’, desde el ordenador local, Google Drive o Bookshare. También se puede usar una extensión de Chrome y Firefox para añadir características de lectura en voz alta al navegador, que pueden funcionar al leer EPUB en algunas plataformas de bibliotecas. 

Lo que gustó a nuestros evaluadores: Las características familiares en Kurzweil están disponibles en ficheros EPUB, incluidos modos flexibles de lectura en voz alta, con voces de alta calidad, diccionario, diccionario de imágenes, tesaurus, traducciones y función de resaltados para estudiar. Se ofrecen varios colores de fondo. La tabla de contenido se encuentra en el menú Marcadores.
...
Lo que gustó a nuestros evaluadores: No es necesario instalar ningún software. Simplemente dirige tu navegador a la web de RedShelf. Las definiciones de palabras están a un paso, y es fácil añadir puntos destacados y crear tarjetas flash, que se almacenan instantáneamente en la nube.
